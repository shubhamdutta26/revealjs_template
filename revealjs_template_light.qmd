...
ggplot(
  ...
  theme_bw(base_size = 12, paper = "#EDEDED") +
  theme(
    legend.position = "none",
    text = element_text(colour = sd_colors["light_text"], family = "Open Sans"),
...
ggplot(
  ...
  geom_bar(aes(alpha = dose), stat = "identity", colour = NA, size = 2) +
  geom_textbox(
    data = plot_data,
    aes(
      label = paste0(
  ...
  coord_flip() +
  facet_wrap(supplement ~ ., ncol = 1) +
  theme_bw(base_size = 12, paper = "#272822", ink = "#FFFFFF") +
  theme(
    legend.position = "none",
